...
@endif
    ...
    <audio id="myAudio" controls>
      ...
      <div id="aviso">
        <img src="{{asset('iconeaviso.png')}}"  style="width: 100px; height: 100px">
        <br>
        <br>
        Você está na fila da espera para o racha, ao bater 1 hora antes do racha serão feitas as listas de confirmados ou até o dono do racha confirmar...
      </div>
    <script>
